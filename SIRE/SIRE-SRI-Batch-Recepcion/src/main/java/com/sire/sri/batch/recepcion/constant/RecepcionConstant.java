...
public class RecepcionConstant {
    ...
    public static String NOTA_CREDITO_SQL = "SELECT COD_EMPRESA, RUC_EMPRESA, "
            ...
            + "ESTADO_SRI='GRABADA' AND ROWNUM <= 20 ORDER BY FECHA_EMISION";
    ...
    public static String GUIA_REMISION_SQL = "SELECT COD_EMPRESA, RUC_EMPRESA, "
            ...
            + "NUM_DESPACHO_INTERNO, CLAVE_ACCESO, ESTABLECIMIENTO, PUNTO_EMISION, "
            + "SECUENCIAL, DIRECCION_MATRIZ, DIRECCION_ESTABLECIMIENTO, "
            ...
            + "ESTADO_SRI='GRABADA' AND ROWNUM <= 20 ORDER BY ????????????"; //TODO
