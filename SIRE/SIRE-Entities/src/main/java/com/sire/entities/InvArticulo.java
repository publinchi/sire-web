...
@NamedQueries({
    ...
    @NamedQuery(name = "InvArticulo.findByArticuloEmpresaEstado", query = "SELECT i FROM InvArticulo i WHERE i.invArticuloPK.codArticulo = :codArticulo AND i.invArticuloPK.codEmpresa = :codEmpresa AND i.estado = :estado")})
