...
@NamedQueries({
    ...
    @NamedQuery(name = "InvUnidadAlternativa.findByCodArticulo", query = "SELECT i FROM InvUnidadAlternativa i WHERE i.invUnidadAlternativaPK.codArticulo = :codArticulo"),
