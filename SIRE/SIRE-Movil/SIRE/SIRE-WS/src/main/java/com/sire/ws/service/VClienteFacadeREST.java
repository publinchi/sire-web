...
public class VClienteFacadeREST extends AbstractFacade<VCliente> {
    ...
    @GET
    @Path("/findByRazonSocialEmpresa/{razonSocial}/{codEmpresa}")
    @Produces({"application/json"})
    public List<VCliente> findByRazonSocialEmpresa(@PathParam("razonSocial") String razonSocial, @PathParam("codEmpresa") String codEmpresa) {
        TypedQuery<VCliente> query = em.createNamedQuery("VCliente.findByRazonSocialEmpresa", VCliente.class);
        query.setParameter("razonSocial", razonSocial.toUpperCase());
        query.setParameter("codEmpresa", codEmpresa);
        List<VCliente> retorno = query.getResultList();
        return retorno;
    ...
    @GET
    @Path("/findByNombresApellidosEmpresa/{input}/{codEmpresa}")
    @Produces({"application/json"})
    public List<VCliente> findByNombresApellidosEmpresa(@PathParam("input") String input, @PathParam("codEmpresa") String codEmpresa) {
        TypedQuery<VCliente> query = em.createNamedQuery("VCliente.findByNombresApellidosEmpresa", VCliente.class);
        query.setParameter("nombres", input.toUpperCase());
        query.setParameter("apellidos", input.toUpperCase());
        query.setParameter("codEmpresa", codEmpresa);
        List<VCliente> retorno = query.getResultList();
