...
import com.sire.entities.CxcClientePK;
...
public class CxcClienteFacadeREST extends AbstractFacade<CxcCliente> {
    ...
    private CxcClientePK getPrimaryKey(PathSegment pathSegment) {
        /*
         * pathSemgent represents a URI path segment and any associated matrix parameters.
         * URI path part is supposed to be in form of 'somePath;codEmpresa=codEmpresaValue;codCliente=codClienteValue'.
         * Here 'somePath' is a result of getPath() method invocation and
         * it is ignored in the following code.
         * Matrix parameters are used as field names to build a primary key instance.
         */
        com.sire.entities.CxcClientePK key = new com.sire.entities.CxcClientePK();
        ...
        if (codCliente != null && !codCliente.isEmpty()) {
            key.setCodCliente(new java.math.BigInteger(codCliente.get(0)));
        }
        return key;
    }

    public CxcClienteFacadeREST() {
