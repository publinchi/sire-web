...
import 'package:sire_frontend/tabs/accounts.dart';
import 'package:sire_frontend/tabs/bills.dart';
import 'package:sire_frontend/tabs/budgets.dart';
import 'package:sire_frontend/tabs/contratos.dart';
import 'package:sire_frontend/tabs/overview.dart';
...
class _HomePageState extends State<HomePage>
  ...
  Future<List<ContratoData>> getContratos(int codCliente) async {
    ...
    if (response.statusCode == 200) {
      ...
      List<ContratoData> contratoDatas = List<ContratoData>.from(l.map((model)=>
          ContratoData.fromJson(model)));
                ...
                body: SafeArea(
                  ...
                  child: Theme(
                    ...
                    child: FocusTraversalGroup(
                      ...
                      child: getTabBarView(context, isDesktop, theme, snapshot.data),
                    ),
                  ),
                ),
              );
      ...
      /*child: Scaffold(
        body: SafeArea(
          ...
          child: Theme(
            ...
            child: FocusTraversalGroup(
              policy: OrderedTraversalPolicy(),
              child: getTabBarView(context, isDesktop, theme),
            ),
          ),
        ),
      ),*/
