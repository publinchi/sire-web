...
import 'package:sire_frontend/codeviewer/code_displayer.dart';
import 'package:sire_frontend/codeviewer/code_segments.dart';
import 'package:sire_frontend/data/icons.dart';

import 'package:sire_frontend/deferred_widget.dart';
import 'package:sire_frontend/demos/cupertino/cupertino_demos.dart'
    deferred as cupertino_demos;
import 'package:sire_frontend/demos/cupertino/demo_types.dart';
import 'package:sire_frontend/demos/material/material_demos.dart'
    deferred as material_demos;
import 'package:sire_frontend/demos/material/material_demo_types.dart';
import 'package:sire_frontend/demos/reference/motion_demo_container_transition.dart'
    deferred as motion_demo_container;
import 'package:sire_frontend/demos/reference/motion_demo_fade_through_transition.dart';
import 'package:sire_frontend/demos/reference/motion_demo_fade_scale_transition.dart';
import 'package:sire_frontend/demos/reference/motion_demo_shared_x_axis_transition.dart';
import 'package:sire_frontend/demos/reference/motion_demo_shared_y_axis_transition.dart';
import 'package:sire_frontend/demos/reference/motion_demo_shared_z_axis_transition.dart';
import 'package:sire_frontend/demos/reference/colors_demo.dart'
    deferred as colors_demo;
import 'package:sire_frontend/demos/reference/transformations_demo.dart'
    deferred as transformations_demo;
import 'package:sire_frontend/demos/reference/typography_demo.dart'
...
Map<String, GalleryDemo> studies(GalleryLocalizations localizations) {
  return <String, GalleryDemo>{
    ...
    'rally': GalleryDemo(
      title: 'Clientes',
      subtitle: ('Pago de Cuotas'),//localizations.rallyDescription,
      category: GalleryDemoCategory.study,
      studyId: 'rally',
    ),
    'crane': GalleryDemo(
