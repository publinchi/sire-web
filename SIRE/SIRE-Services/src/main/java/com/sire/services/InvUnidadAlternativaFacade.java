 ...
 */
@Stateless
public class InvUnidadAlternativaFacade extends AbstractFacade<InvUnidadAlternativa> implements InvUnidadAlternativaFacadeRemote {
    ...
    public InvUnidadAlternativaFacade() {
