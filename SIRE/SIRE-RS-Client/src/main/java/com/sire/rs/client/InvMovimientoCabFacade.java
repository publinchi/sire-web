...
/**
 * Jersey REST client generated for REST resource:InvMovimientoCabFacade
 [com.sire.entities.invmovimientocab]<br>
 * USAGE:
 * <pre>
        InvMovimientoCabFacade client = new InvMovimientoCabFacade();
 ...
 */
public class InvMovimientoCabFacade {
    ...
    public InvMovimientoCabFacade() {
        ...
        webTarget = client.target(BASE_URI).path("com.sire.entities.invmovimientocab");
    }
