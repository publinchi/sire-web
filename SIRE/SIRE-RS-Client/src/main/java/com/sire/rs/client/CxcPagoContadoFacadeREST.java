...
/**
 * Jersey REST client generated for REST resource:CxcPagoContadoFacadeREST
 * [com.sire.entities.cxcpagocontado]<br>
 * USAGE:
 * <pre>
 *        CxcPagoContadoFacadeREST client = new CxcPagoContadoFacadeREST();
 ...
 * @author root
 */
public class CxcPagoContadoFacadeREST {
    ...
    public CxcPagoContadoFacadeREST() {
        ...
        webTarget = client.target(BASE_URI).path("com.sire.entities.cxcpagocontado");
    }
    ...
    public <T> T findByFechas_XML(Class<T> responseType, String fechaInicio, String fechaFin, String codEmpresa, String codVendedor) throws ClientErrorException {
        WebTarget resource = webTarget;
